...
class UserManager(models.Manager):
    ...
    def create_user(self, postData):
        ...
        email_hash = bcrypt.hashpw(
            postData['email'].encode(), bcrypt.gensalt())
        self.create(first_name=postData['first_name'], last_name=postData['last_name'],
                    email=postData['email'], email_hash=email_hash, password=pw_hash)
        return create
